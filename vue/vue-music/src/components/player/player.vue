...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      next() {
        // 解决连续点击报错的问题，只有当audio准备能播放时才能点击
        if (!this.songReady) {
          return
        }
      ...
      middleTouchMove(e) {
        ...
        this.$refs.middleL.style[transform] = `translate3d(${offsetWidth}px,0,0)`
      ...
      // 切换播放模式时，为了不使用当播放的歌曲受影响，则需要重置当前播放歌曲的index

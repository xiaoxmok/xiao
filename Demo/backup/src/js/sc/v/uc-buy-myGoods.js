...
define(function(require, exports, module) {
    ...
    $(function() {
        ...
        // 更多 当前小弹出窗
        $('.messageTip').tipShow({"width":"200","x":-18});
        $('.noteTip').tipShow({"width":"160"});

        $("#searchOptsBtn").click(function(){
            var bool = $(this).hasClass("lap");
            if(!bool){
                $(this).addClass("lap");
                $("#proMoreOptsBox").slideUp();
            }else{
                $(this).removeClass("lap");
                $("#proMoreOptsBox").slideDown();
            }
        })

...
define(function(require, exports, module) {
    ...
    $(function() {
        ...
        // 单项删除
        $('.tb-creditLv-list').find('.lnk-detele').on('click',function(){

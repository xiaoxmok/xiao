...
var Lottery = function (_mix) {
    ...
    _createClass(Lottery, [{
        ...
        value: function initEvent() {
            ...
            (0, _jquery2.default)('.dxjo').on('click', 'a', self.assistHandle.bind(self));
            (0, _jquery2.default)('.qkmethod').on('click', '.btn-middle', self.getRandomCode.bind(self));
            (0, _jquery2.default)('.lnk-calcel').on('click', self.clearBollActive.bind(self));
            (0, _jquery2.default)('#mul').on('keyup', self.getTotal.bind(self));
        }
    }]);
...
var Base = function () {
    ...
    _createClass(Base, [{
        ...
        value: function changePlayNav(e) {
            ...
            (0, _jquery2.default)('#play_tips').html(self.play_list.get(self.cur_play).selectNumArea);
        ...
        key: 'clearBollActive',
        value: function clearBollActive() {
            var self = this;
            (0, _jquery2.default)('.boll-list .btn-boll').removeClass('btn-boll-active');
            (0, _jquery2.default)('.dxjo .btn-middle').removeClass('btn-middle-active');
            self.getCount();
        }
        ...
        value: function assistHandle(e) {
            ...
            var self = this;
            var $cur = (0, _jquery2.default)(e.currentTarget);
            var index = e.currentTarget.getAttribute('count');
            (0, _jquery2.default)('.dxjo .btn-middle').removeClass('btn-middle-active');
            if (index !== '5') {
        ...
        value: function getTotal() {
            ...
            var mul = (0, _jquery2.default)('#mul').val();
            console.log(mul);
            (0, _jquery2.default)('#count').text(count);
            (0, _jquery2.default)('#money').text(count * 2 * mul);
        }
...
var Inerface = function () {
    function Inerface() {
        _classCallCheck(this, Inerface);
    }

    _createClass(Inerface, [{
        key: 'getOmit',
